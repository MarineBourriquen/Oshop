...
<form action="" method="POST" class="mt-5">
    <div class="mb-3">
        ...
        <input value="<?= $category->getName() ?>" name="name" type="text" class="form-control" id="name" placeholder="Nom de la catégorie">
    </div>
    <div class="mb-3">
        <label for="subtitle" class="form-label">Sous-titre</label>
        <input value="<?= $category->getSubtitle() ?>"  name="subtitle" type="text" class="form-control" id="subtitle" placeholder="Sous-titre" aria-describedby="subtitleHelpBlock">
