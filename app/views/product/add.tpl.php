...
<form action="" method="POST" class="mt-5">
    ...
    <div class="form-group">
        ...
        <input name="description"  type="text" class="form-control" id="description" placeholder="Sous-titre" 
    ...
    <div class="form-group">
        ...
        <input name="rate"  type="text" class="form-control" id="rate" placeholder="Note" 
    ...
    <div class="form-group">
        ...
        <select name="status"  class="custom-select form-select" id="status" aria-describedby="statusHelpBlock">
    ...
    <div class="form-group">
        ...
        <select name="category"  class="custom-select form-select" id="category" aria-describedby="categoryHelpBlock">
    ...
    <div class="form-group">
        ...
        <select  name="brand"  class="custom-select form-select" id="brand" aria-describedby="brandHelpBlock">
    ...
    <div class="form-group">
        ...
        <select name="type"  class="custom-select form-select" id="type" aria-describedby="typeHelpBlock">
